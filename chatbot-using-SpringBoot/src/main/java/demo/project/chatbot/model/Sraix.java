...
import demo.project.chatbot.utils.NetworkUtils;


public class Sraix {

	private static final Log log = LogFactory.getLog(Sraix.class);
    ...
    private static final Log LOGGER = LogFactory.getLog(Sraix.class);
    ...
    public static String sraixPannous(String input, String hint, Chat chatSession)  {
        try {
        	...
        	LOGGER.error("Exception occured while getting response => "+ex.getMessage());
        	//ex.printStackTrace(); //enable it for debbuging
